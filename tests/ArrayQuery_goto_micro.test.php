<?php 
class ArrayQuery_goto_microTests extends \Enhance\TestFixture
{
  private $target;
	private $array;
	...
	public function setUp()
	{
		...
		include_once('src/ArrayQuery_goto_micro.class.php');
		include('data/data_big.php');
		$this->array=$array; //set from data file
		$this->target = \Enhance\Core::getCodeCoverageWrapper('ArrayQuery_goto_micro',array($this->array));
	}
